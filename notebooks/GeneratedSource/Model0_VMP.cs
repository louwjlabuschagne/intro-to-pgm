...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.2102.1701 at 13:47 on Thursday, 30 September 2021.
	/// </remarks>
	public partial class Model0_VMP : IGeneratedAlgorithm
	{
		#region Fields
		public Bernoulli bothHeads_F;
		/// <summary>True if Changed_secondCoin has executed. Set this to false to force re-execution of Changed_secondCoin</summary>
		public bool Changed_secondCoin_isDone;
		...
		public bool secondCoin
		{
			...
			set {
				if (this.SecondCoin!=value) {
					...
					this.Changed_secondCoin_isDone = false;
				}
			}
		}
		...
		{
			return this.bothHeads_F;
		}

		/// <summary>Computations that depend on the observed value of secondCoin</summary>
		private void Changed_secondCoin()
		{
			if (this.Changed_secondCoin_isDone) {
				return ;
			}
			this.firstCoin_marginal_F = Bernoulli.Uniform();
			// Message to 'bothHeads' from And factor
			this.bothHeads_F = BooleanAndOp.AndAverageLogarithm(this.firstCoin_marginal_F, this.SecondCoin);
			this.secondCoin_marginal_F = Bernoulli.Uniform();
			// Message to 'secondCoin_marginal' from DerivedVariableVmp factor
			this.secondCoin_marginal_F = DerivedVariableVmpOp<bool>.MarginalAverageLogarithm<Bernoulli,bool>(this.SecondCoin, this.secondCoin_marginal_F);
			this.Changed_secondCoin_isDone = true;
		}
