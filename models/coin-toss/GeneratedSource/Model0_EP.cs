...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.2102.1701 at 09:07 on Thursday, 30 September 2021.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_secondCoin()
		{
			...
			bothHeads_F = BooleanAndOp.AndAverageConditional(vBernoulli0, this.SecondCoin);
			...
			// Message to 'secondCoin_marginal' from DerivedVariable factor
			this.secondCoin_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli,bool>(this.SecondCoin, this.secondCoin_marginal_F);
